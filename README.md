...
* **AI Agent Integration:** Connect any MCP-compatible agent to control a selected server debugger, read server or client telemetry, and inspect runtime errors or GLuaLS diagnostics across multiple debug sessions.
